namespace BankSystem.Web.Pages.Account.Settings
{
    ...
    public class Enable2faModel : BasePageModel
    {
        ...
        public Enable2faModel(UserManager<User> userManager, ILogger<Enable2faModel> logger,
            UrlEncoder urlEncoder, SignInManager<User> signInManager)
        {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(User user, bool resetKey = false)
        {
